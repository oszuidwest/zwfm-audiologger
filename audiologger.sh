...
ffmpeg -loglevel error -user_agent "ZuidWest Audiologger 3.1" -t 3600 -reconnect 1 -reconnect_at_eof 1 -reconnect_streamed 1 -i "$STREAMURL" -c copy -f mp3 -y "${RECDIR}/${TIMESTAMP}.mp3" & disown
